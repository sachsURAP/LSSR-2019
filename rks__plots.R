...
source("rks_monteCarlo.R") # Load Monte Carlo.
...
errbar(40, rks_mix_data[6,"Prev"],
       yplus  = rks_mix_data[6,"Prev"] + rks_mix_data[6,"SD"] , 
       yminus = rks_mix_data[6,"Prev"] -  rks_mix_data[6,"SD"], 
...
#=======================================================================#
#======== Fig. 7A. 80% LowLET and Four HZE Ions CI included=============#
#=======================================================================#
